/**
 * Generates pre-computed turn hands with high-accuracy Monte Carlo simulation.
 * Run with: npx tsx scripts/generate-turn-hands.ts
 *
...
async function main() {
  console.log(`Generating ${TOTAL} turn hands with ${SIMS.toLocaleString()} simulations each...`);
  ...
  for (let i = 0; i < TOTAL; i++) {
    ...
    const equity = calculateEquity(heroCards, villainRange, [...flop, turnCard], SIMS);

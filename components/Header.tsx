  ...
  return (
    <header className="relative flex items-center px-6 py-4 bg-gray-900 text-white">
      ...
      <nav className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-8">
        <Link href="/train" className="flex items-center gap-1.5 text-sm hover:text-lime-400 transition-colors">
        ...
        <Link href="/glossary" className="flex items-center gap-1.5 text-sm hover:text-lime-400 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Link href="/hall-of-fame" className="flex items-center gap-1.5 text-sm hover:text-lime-400 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">

...
export default function HandVsRangeFlopPage() {
  ...
  async function startNewHand(diff?: number) {
    ...
    setHand({ ...result, flopCards: result.flopCards ?? [], difficulty: d });
    setLoading(false);
  }
      ...
      <div className="flex flex-wrap items-center gap-2">
        {[1, 2, 3, 4].map((level) => {
          ...
          return (
            ...
            >
              {!isUnlocked && (
                <svg className="inline mr-1 mb-0.5" width="11" height="11" viewBox="0 0 24 24" fill="currentColor">

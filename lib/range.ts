...
export const HAND_RANKINGS: string[] = [
  ...
  "QTs","A7s","K9s","JTs","ATo","33","A6s","A5s","K8s","QJo","A4s","Q9s",
  "K7s","A3s","JTo","22","K6s","A2s","K5s","QTo","J9s","K4s","Q8s","K3s",
  "T9s","K2s","J8s","Q7s","K9o","T8s","Q6s","J9o","Q5s","97s","J7s","Q4s",
  "T9o","Q3s","96s","J6s","Q2s","T7s","K8o","J5s","86s","Q9o","J4s","T6s",
  "75s","J3s","95s","K7o","KJo","J2s","T5s","64s","T4s","K6o","85s","T3s","53s",
  "74s","T2s","K5o","KTo","J8o","Q8o","63s","43s","K4o","54s","98s","93s","T8o","K3o",
